...
L'intervallo di confidenza indica quanto l'imprecisione della misura influisce sull'interpretazione dei dati. Più l'intervallo di confidenza è ampio, maggiore è l'incertezza nella valutazione dei risultati. Tuttavia, l'intervallo di confidenza può essere utilizzato per fare conclusioni con una certa probabilità di essere corrette. Ad esempio, se si utilizza un intervallo di confidenza del 95%, c'è solo una probabilità del 5% di commettere un errore nella valutazione dei dati. Se lo psicologo desidera ridurre ulteriormente la probabilità di errore, può utilizzare un valore di $\alpha$ più piccolo. Tuttavia, ciò comporta un aumento dell'ampiezza dell'intervallo di confidenza. In generale, i valori di $\alpha$ accettabili sono 0.1 e 0.05.
