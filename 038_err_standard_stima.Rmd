...
L'errore standard della stima si può calcolare con la funzione `SE.Est()` del pacchetto `psychometric`.
...
La funzione `CI.tscore()` restituisce sia la stima del punteggio vero sia l'intervallo di fiducia al livello desiderato di significatività. 
