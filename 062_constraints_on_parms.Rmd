# Attendibilità e modello fattoriale {#ch:cronbach}
...
La \@ref(eq:spearman-brown-der) esprime l'attendibilità di un test costituito da $p$ item paralleli nei termini dell'attendibilità di un solo item ed è tradizionalmente conosciuta come la formula di Spearman-Brown (*Spearman-Brown prophecy formula*). Nel caso di item
paralleli si ha che
