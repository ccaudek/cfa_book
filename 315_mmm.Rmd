...
@brown2015confirmatory suggerisce di analizzare la matrice MTMM con un modello CFA il quale ipotizza correlazioni residue tra le unicità di ciascun metodo. Il modello è formulato nel modo seguente. Ogni fattore comune (`paranoid`, `schizotypal`, `schizoid`) è identificato dagli item corrispondenti definiti da metodi diversi. Le specificità di ciascun metodo sono tra loro correlate.
