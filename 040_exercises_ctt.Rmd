...
L'analisi degli item svolge un ruolo importante nello sviluppo e nella revisione dei test psicometrici. L'analisi degli item può essere eseguita utilizzando le funzioni di base fornite da R. Torniamo al set di dati SAPA per dimostrare come eseguire l'analisi degli item nel caso di risposte dicotomiche.
