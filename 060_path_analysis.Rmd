# Path Analysis {#ch:path_analysis}
...
$$0.25 + 0.16  + 0.10 + 0.10= 0.61.$$ Inoltre, dato che le variabili
...
variabili $x_1$ e $x_2$ è quindi uguale a $$1-0.61 = 0.39.$$
...
Vengono simulate 100 osservazioni su tre variabili. Imponendo un effetto
causale diretto delle variabili $x_1$ e $x_2$ sulla $y$ e una
correlazione $> 0$ tra le variabili $x_1$ e $x_2$, otteniamo i seguenti
dati:
...
`lavaan` consente di stimare i coefficienti di percorso. Le relazioni
tra le variabili sono speficicate con la sintassi descritta nel manuale.
