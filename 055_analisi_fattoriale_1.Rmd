...
dove $\xi$ rappresenta il fattore comune a tutte le $y_i$, $\varepsilon_i$ sono i fattori specifici o unici di ogni variabile osservata e $\lambda_i$ sono le
...
dove $\lambda_i$ è il carico o il peso della variabile $i$-esima sul fattore comune e $\varepsilon_i$ rappresenta il fattore specifico della variabile $i$-esima. Si assume che il fattore comune abbia media zero e varianza unitaria, mentre i fattori specifici abbiano media zero, varianza $\psi_{i}$ e siano incorrelati tra loro e con il fattore comune. Nel modello unifattoriale, l'interdipendenza tra le variabili è completamente spiegata dal fattore comune.
