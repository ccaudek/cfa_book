# Il modello unifattoriale {#ch:spearman}
...
Definiamo il modello unifattoriale con la sintassi di `lavaan`, laddove l'operatore `=~` si può leggere dicendo che la variabile latente a sinistra dell'operatore è definita dalle variabili manifeste elencate a destra dell'operatore e separate dal segno `+`.
...
Il parametro `std.lv = TRUE` specifica che imponiamo una varianza pari a 1 a tutte le variabili latenti comuni (nel caso presente, solo una). Ciò consente di potere stimare le saturazioni fattoriali.
