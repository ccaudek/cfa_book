...
Secondo Lord e Novick (1968), l'errore $E = X - T$ è la variabile aleatoria di primario interesse per la CTT, in quanto lo scopo è stimare il punteggio vero di ciascun rispondente e confrontare le stime ottenute per rispondenti diversi. La grandezza dell'errore che si commette utilizzando il punteggio osservato come misura del punteggio vero può essere quantificata dalla deviazione standard di $E$, $\sigma_E$, chiamata "errore standard della misurazione" o SEM. Ma come si può stimare $\sigma_E$?

## L'incertezza della misura 

L'errore standard della misurazione rappresenta il grado di incertezza presente nei punteggi di un test. Secondo la CTT, è possibile stimare l'errore standard della misurazione ($\sigma_E$) utilizzando l'equazione:
...
È importante notare che l'errore standard della misurazione $\sigma_E$ è direttamente legato all'attendibilità del test: l'errore standard
...
se.m <- function(responses, rel.est = "alpha") {
  ...
  } else if (rel.est == "KR20") {
    rel <- KR20(responses)
  } else if (rel.est == "KR21") {
    rel <- KR21(responses)
  } else {
